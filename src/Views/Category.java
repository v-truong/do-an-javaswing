...
public class Category extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setBackground(new java.awt.Color(1, 145, 96));
        ...
        jLabel4.setText("Tên thể loại sách");
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        ca.setCategoryName(jTextField1.getText());
        ca.setDescription(jTextArea1.getText());
        new CategoryController().CreateCategory(ca.getCategoryName(), ca.getDescription());
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        CategoryModel Pb = categoryModels.get(selectedIndex);
        JOptionPane.showConfirmDialog(this, "bạn cóc chắc muốn xóa ko!");
        new CategoryController().DeleteCategory(Pb.getCategoryID());
        this.dispose();
        Category at = new Category();
        at.setVisible(true);
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        selectedIndex = jTable2.getSelectedRow();
        CategoryModel Ca = categoryModels.get(selectedIndex);
        jTextField1.setText(Ca.getCategoryName());
        jTextArea1.setText(Ca.getDescription());
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ...
        Ca.setCategoryName(jTextField1.getText());
        Ca.setDescription(jTextArea1.getText());
        JOptionPane.showConfirmDialog(this, "Bấm OK để để sủa lại :");
        new CategoryController().UpdateCategory(Ca.getCategoryID(), Ca.getCategoryName(), Ca.getDescription());
        this.dispose();
        Category at = new Category();
        at.setVisible(true);
    ...
    private void showTable() {
        ...
        for (CategoryModel categoryModel : categoryModels) {
            tableModel.addRow(new Object[]{
                categoryModel.getCategoryID(), categoryModel.getCategoryName(), categoryModel.getDescription(),});
        }
    }
}
